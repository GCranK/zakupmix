document.addEventListener("DOMContentLoaded", () => {
        ...
        shakePear: {
            ...
            kitchen: {
                "Мясо": [
                    ...
                    "Сосиски", "Салями", "Докторская колбаса", "Жир", "Баварские колбаски", "Ветчина", "Тунец"
                ],
                "Фрукты/овощи": [
                    "Морковь", "Лук", "Лук шалот", "Картошка", "Помидоры", "Чеснок", "Баклажаны",
                    "Дайкон", "Свекла", "Огурцы", "Капуста", "Болгарский перец", 
                    "Шампиньоны", "Болгарский светофор", "Лимоны", "Апельсины", "Яблоки", "Бананы", "Черри помидоры"
                ],
                "Зелень": [
                ...
                "Бакалея": [
                    ...
                    "Кунжутное масло", "Перепелиные яйца", 
                    ...
                    "Дрожжи ангел", "Маслины", "Оливки", "Мука", "Консервированный Горошек", "Горчица"
                ],
                "Молочные продукты": [
    ...
    ijodCafe: {
        ...
        kitchen: {
            "Мясо": [
                "Говядина яблочки", "Говядина мякоть", "Куриные бёдра", "Куриное филе", "Куриная голень", "Шапок", 
                "Куриные крылышки", "Говяжий фарш", "Индейка", "Копчёная говядина", 
                "Сосиски", "Колбаса копченая", "Колбаса вареная", "Жир", "Бараний жир", "Баварские колбаски", "Ветчина", "Тунец"
            ],
            "Фрукты/овощи": [
                "Морковь", "Лук", "Лук шалот", "Картошка", "Помидоры", "Чеснок", "Баклажаны",
                "Дайкон", "Свекла", "Огурцы", "Капуста", "Болгарский перец", 
            ...
            "Бакалея": [
                "Яйца", "Сахар", "Сахарные кубики", "Соль", "Томатная паста", "Кетчуп", "тесто для лагмана", 
                "Майонез", "Сливочное масло", "Щедрое лето", "Оливковое масло", "Фритюрное масло", 
                "Кунжутное масло", "Перепелиные яйца", "Булгур", "Горох нут", "Сухари панко", "Сахарный пудра", 
                "Томатный сок", "Соя", "Фасоль консервированная", "Кукуруза консервированная",
                "Красная икра", "Домашняя лапша", "Арахис в глазури", "Пергамент Большой", "Пергамент маленький",
                "Бамбуковые шпажки", "Джем Клубника", "Джем Малина", "Джем ягодный микс", "Маринованные огурцы",
                "Галина бланка курица", "Галина бланка говядина", "Chococream Большой", "Чокотелло Большой", "Чокотелло маленький", "Chococream маленький", 
                "Дрожжи ангел", "Маслины", "Оливки", "Мука", "Консервированный Горошек", "Горчица", "Сгущенка вареная", 
            ],
            "Молочные продукты": [
                "Молоко", "Сливки 20%", "Фетакса", "Творог", "Голландский сыр", "Гауда сыр", 
                "Пармезан", "Виола сыр", "Творожный сыр", "Чиз сыр (пластинки)", "Сыр моцарелла", "Сыр сулугуни"
            ],
            "Прочее": [
                "Навват", "Халва", "Курага", "Финики", "Банан сухофрукт", "Сухофрукты",
                "Орехи", "Арахис", "Киш-миш", "Миндаль", "Крабовые палочки", "Креветки",
