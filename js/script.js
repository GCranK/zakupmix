    ...
    const products = {
        shakePear: {
            bar: {
                ...
                "Бакалея": [
                    "Сахар", "Чай чёрный", "Чай зелёный", " Чёрный чай фруктовый пакетики", "Мед", "Мускатный орех",
            ...
            kitchen: {
                ...
                "Фрукты/овощи": [
                    ...
                    "Шампиньоны", "Болгарский светофор красный", "Болгарский светофор зеленый", "Болгарский светофор желтый", "Лимоны", "Апельсины", "Яблоки", "Бананы", "Черри помидоры", "Редиска", "Редька"
                ],
                "Зелень": [
